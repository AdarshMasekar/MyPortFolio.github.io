...
const Experience = (props: Props) => {
  return (
    ...
    >
      ...
      <h3 className="absolute top-36 uppercase tracking-[5px] text-xs text-secondary mb-3">
        hover over a  {" "}<span className="text-third text-lg font-bold animate-pulse">card</span>
