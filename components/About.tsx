      ...
      viewport={{
       ...
       className="lg:mt-32  flex flex-col space-y-10 px-0 sm:my-3 md:px-10">
        ...
        <p className="text-lg tracking-widest leading-8 text-primary/70 ">
          I&apos;m a Graduate student of <span className="branch text-secondary" id="branch">Computer Science and Engineering </span>, My current <span className="text-semibold text-secondary/90">CGPA</span> is <span className="text-bolder text-secondary">8.3. </span>
