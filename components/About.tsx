    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        ...
        <p className="text-md tracking-widest leading-8 ">
          ...
          I have Been active on  <span className="text-bold text-xl text-[#ff713e]"><a href="https://leetcode.com/adarshmasekar/">Leetcode</a>  <a href="https://www.codingninjas.com/codestudio/profile/Adarsh_55">Coding Ninjas</a></span> platforms for practicing problem solving skills and enhancing hoow to use my DSA knowledge in realworld .
        </p>
      </div>
